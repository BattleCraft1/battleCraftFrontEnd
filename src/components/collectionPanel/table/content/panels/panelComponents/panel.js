...
import PanelButton from '../panelComponents/panelButton'
    ...
    setActive(name){
      ...
      if(name == "participants"){
        ...
        render(){
          ...
          const organisators = <div>
                                 <Table name={"Organisators"} /*rows={"HereAddRows"}*//>
                                 <PanelButton text={"Add"}/>
                               </div>
          const participants = <div>
                                 <Table name={"Participants"} /*rows={"HereAddRows"}*//>
                                 <PanelButton text={"Add"}/>
                               </div>

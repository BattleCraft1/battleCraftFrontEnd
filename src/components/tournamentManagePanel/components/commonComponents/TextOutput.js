...
export default class TextOutput extends React.Component{
    ...
    render(){
        return(
                <div style={Object.assign({}, styles.textOutput, {textAlign:this.props.alignment})}>
                ...
                <div style={Object.assign({}, styles.value)}>{this.props.value === ""?'NO NAME':this.props.value}</div>
                </div>
        )
    }
}
